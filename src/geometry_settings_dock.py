...
class GeometrySettingsDock(QDockWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.icon = QIcon(str((self.parent().data.src_folder / "images/icons/icons8-octahedron-64.png").absolute()))
        icon_label = QLabel()
        icon_label.setPixmap(self.icon.pixmap(QSize(32, 32)))

        title_layout.addWidget(icon_label)
        title_layout.addSpacing(2)
        title_layout.addWidget(QLabel("Geometry"))
